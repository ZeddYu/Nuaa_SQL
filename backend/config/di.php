...
//\PhalApi\DI()->response->addHeaders('Access-Control-Allow-Origin', '*');
//\PhalApi\DI()->response->addHeaders("Access-Control-Allow-Credentials", "true");
//\PhalApi\DI()->response->addHeaders("Access-Control-Allow-Methods", "GET,HEAD,OPTIONS,POST,PUT");
//\PhalApi\DI()->response->addHeaders("Access-Control-Allow-Headers", "Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers");